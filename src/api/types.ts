...
import { Blob } from "../chain/blob.js"
import { BlockId } from "../chain/block-id.js"
...
import { Int32, Int64, UInt128, UInt16, UInt32, UInt32Type, UInt64 } from "../chain/integer.js"
import { Name, NameType } from "../chain/name.js"
import { PublicKey, PublicKeyType } from "../chain/public-key.js"
...
import { Transaction, TransactionHeader, TransactionReceipt } from "../chain/transaction.js"
import { ABISerializableObject, ABISerializableType } from "../serializer/serializable.js"
import pako from 'pako'
import { PermissionLevel } from "../chain/permission-level.js"
import { AnyAction } from "../chain/action.js"
import { Authority, KeyWeight, Weight } from "../chain/authority.js"
...
export class GetInfoResponse extends Struct {
    ...
    @Struct.field('string?') declare server_version_string?: string
    /** Sequential block number representing the best known head in the fork database tree. */
    @Struct.field('uint32?') declare fork_db_head_block_num?: UInt32
    /** Hash representing the best known head in the fork database tree. */
    @Struct.field('block_id_type?') declare fork_db_head_block_id?: BlockId
